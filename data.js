...
const referencesData = [
    { code: 'DUA 3.0', title: 'Diseño Universal para el Aprendizaje, versión 3.0 CAST', file: 'articulo-dua-3.0-morilla-y-alvarez.pdf' },
    { code: 'DUA Duoc', title: 'Experiencia DUA en Duoc UC', file: 'Experiencia DUA.pdf' },
    { code: 'ORG', title: 'Organizador gráfico DUA 3.0', file: 'udlg3-graphicorganizer-digital-numbers-a11y-spanish-latin-america.pdf' },
    { code: 'ADE', title: 'Guía de Adecuaciones Curriculares de Acceso', file: 'Guía Adecuaciones Curriculares de Acceso.pdf' },
    { code: 'ACC', title: 'Guía de Introducción a la Accesibilidad Digital', file: 'Guía de Introducción a la Accesibilidad Digital.pdf' },
    { code: 'AUT', title: 'Orientaciones docentes para estudiantes del espectro autista', file: 'Guia Orientaciones Autismo v2024.pdf' },
    { code: 'VOC', title: 'Orientaciones para un vocabulario inclusivo', file: 'Orientaciones Vocabulario Inclusivo.pdf' },
    { code: 'PRÁCTICA', title: 'Cuadernillo de apoyo: De la formación a la práctica', file: 'Cuadernillo de la Formación a la Práctica.pdf' },
    ...
    { code: 'UNE LF', title: 'UNE 153101:2018 EX Lectura Fácil: pautas y recomendaciones para elaborar documentos', file: 'https://revista.une.org/4/primera-norma-tecnica-sobre-lectura-facil.html' },
    { code: 'VALIDACIÓN LF', title: 'UNE 153102:2018 EX: guía en Lectura Fácil para validadores de documentos', file: 'https://revista.une.org/10/guia-en-lectura-facil-para-validadores-de-documentos.html' },
    ...
    { code: 'LEY TEA', title: 'Ley 21.545: inclusión, atención integral y derechos de personas autistas', file: 'https://www.bcn.cl/leychile/navegar?idNorma=1190123' },
    { code: 'LEY 21.015', title: 'Ley 21.015: inclusión laboral de personas con discapacidad', file: 'https://www.bcn.cl/leychile/navegar?idNorma=1103997' },
    { code: 'LEY 21.690', title: 'Ley 21.690: actualiza normas de inclusión laboral de personas con discapacidad', file: 'https://www.bcn.cl/leychile/navegar?i=1206100' },
    { code: 'SENADIS', title: 'SENADIS: inclusión laboral, trabajo como derecho y entornos accesibles', file: 'https://www.senadis.gob.cl/pag/149/1214/descripcion' },
    { code: 'SENADIS 21.015', title: 'SENADIS: orientaciones y preguntas frecuentes sobre Ley de Inclusión Laboral', file: 'https://www.senadis.gob.cl/pag/420/1695/preguntas_frecuentes_ley_de_inclusion_laboral' },
    { code: 'OIT FP', title: 'OIT: inclusión de personas con discapacidad en la formación profesional', file: 'https://researchrepository.ilo.org/esploro/outputs/manual/Inclusion-de-personas-con-discapacidad-en/995264820302676' },
    { code: 'OIT TVET', title: 'OIT: sistemas técnico-profesionales inclusivos para personas con discapacidad', file: 'https://www.ilo.org/publications/making-tvet-and-skills-systems-inclusive-persons-disabilities' },
    { code: 'CAR CURSO', title: 'Plantilla editable: Caracterización inicial del curso', file: '' },
    { code: 'COLAB', title: 'Checklist de prácticas colaborativas inclusivas', file: '' },
    { code: 'RETRO', title: 'Infografía: Yo retroalimento para todos', file: '' },
    { code: 'LENG', title: 'Infografía: Mis palabras crean una comunidad inclusiva', file: '' },
    { code: 'CRISIS', title: 'Infografía: Cómo apoyar a un estudiante que se descompensa en mi aula', file: '' },
    { code: 'CIERRE', title: 'Plantilla de reflexión de cierre de semestre', file: '' }
];
