...
const referencesData = [
    { code: 'DUA 3.0', title: 'Diseño Universal para el Aprendizaje, versión 3.0 CAST', url: 'https://udlguidelines.cast.org/' },
    { code: 'ORG', title: 'Organizador gráfico DUA 3.0 (español)', url: 'https://udlguidelines.cast.org/static/udlg3-graphicorganizer_spanish_update_8142024.pdf' },
    ...
    { code: 'CAST', title: 'CAST: Universal Design for Learning', url: 'https://www.cast.org/' },
    { code: 'WCAG', title: 'W3C WAI: Web Content Accessibility Guidelines', url: 'https://www.w3.org/WAI/standards-guidelines/wcag/' },
